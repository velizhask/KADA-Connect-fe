// ================================================
// CompanyProfilePages.tsx — FINAL CLEAN VERSION
// ================================================
...
/* ============================================================
 * EDIT VIEW (PRIVATE) — MATCHES FIGMA LAYOUT
 * ============================================================ */
function CompanyEdit({ profile, updateProfile, uploadLogo }: any) {
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="p-8">
          <div className="flex flex-col md:flex-row items-start gap-8">
            ...
            <div className="relative shrink-0">
              <div className="w-64 h-40 bg-gradient-to-br from-purple-600 to-purple-700 rounded-3xl text-white flex items-center justify-center text-4xl font-bold shadow-lg">
                {profile.logo ? (
                  <img
                    src={profile.logo}
                    alt="Logo"
      ...
      {/* CONTENT GRID (2 columns left / 1 column right) */}
    ...
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
      ...
      <Card className="rounded-2xl shadow-sm border border-gray-200">
        <div className="p-8 flex flex-col md:flex-row items-center md:items-start gap-6">
          {/* LOGO */}
          <div className="w-64 h-40 bg-gradient-to-br from-purple-600 to-purple-700 rounded-3xl text-white flex items-center justify-center text-4xl font-bold shadow-lg shrink-0">
            {profile.logo ? (
              <img
                src={profile.logo}
                alt="Logo"

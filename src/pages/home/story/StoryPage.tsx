          ...
          <div className="space-y-12 mb-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-lg md:text-xl italic mb-3">
                  "It is amazing since I get to improve my skills (hard and soft
                  skills), gain connections, and gain experience."
                </p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-6">
              ...
              <div className="flex-1 md:text-right">
                <p className="text-lg md:text-xl italic mb-3">
                  "The Industry Visit event through KADA Connect was a
                  game-changer. Met amazing companies and got multiple job
                  offers!"
                </p>
                <p className="text-gray-600 font-medium">Dhiva Manghara</p>
              </div>
